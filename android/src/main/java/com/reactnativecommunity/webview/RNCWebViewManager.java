...
public class RNCWebViewManager extends SimpleViewManager<WebView> {
  ...
  protected static  String JAVASCRIPT_INTERFACE = "ReactNativeWebView";
  ...
  @ReactProp(name = "messaginEnableName")
  public void setMessagingEnabledName(WebView view, String name) {
//    ((RNCWebView) view).setMessagingEnabled(enabled);
    Log.i(TAG, "setMessagingEnabledName: ");
    if (!TextUtils.isEmpty(name)) {
      JAVASCRIPT_INTERFACE = name;
    }
  }


  @ReactProp(name = "userToken")
  public void setUserToken(WebView view, String userToken) {
//    ((RNCWebView) view).setMessagingEnabled(enabled);
    Log.i(TAG, "setUserToken: ");
  ...
  protected static class RNCWebView extends WebView implements LifecycleEventListener {
    ...
    protected RNCWebViewBridge createRNCWebViewBridge(RNCWebView webView) {
      Log.i(TAG, "createRNCWebViewBridge: USER_TOKEN===" + USER_TOKEN);
      if (TextUtils.isEmpty(USER_TOKEN)) {
        return new RNCWebViewBridge(webView);
      } else {
        return new RNCWebViewBridge(webView, USER_TOKEN);
      }
    }
    ...
    public void setMessagingEnabled(boolean enabled) {
      ...
      Log.e(TAG, "setMessagingEnabled: " +JAVASCRIPT_INTERFACE);
      if (enabled) {
    ...
    protected class RNCWebViewBridge {
      //发送到rn的事件接收名称
      public static final String TO_RN_EVENT_NAME = "nativeEvent";
      ...
      RNCWebViewBridge(RNCWebView c, String userToken) {
        Log.i(TAG, "RNCWebViewBridge: ");
        mContext = c;
        this.memberToken = userToken;
      }
      ...
      private void sendEvent(String messageId, String message) {
        ReactContext reactContext = (ReactContext) mContext.getContext();
        if (reactContext != null) {
          WritableMap event = Arguments.createMap();
          event.putString("messageId", messageId);
          event.putString("messageContent", message);
          reactContext
            .getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
            .emit(TO_RN_EVENT_NAME, event);
        }
      }
      ...
      @JavascriptInterface
      public void popToUp() {
        Log.e(TAG, "popToUp: 彩票返回");
        sendEvent("popToUp", "关闭当前页面");
      }
      ...
      public void resetToAccount() {
        try {
          sendEvent("navigatePersonalCenter", "支付跳转到我的账户");
        } catch (Exception e) {
          e.printStackTrace();
        }
      }
       ...
       */
      @JavascriptInterface
      public void weakUpThirdApp(String url) {
        sendEvent("openBrowres", url);
      }
      ...
      private boolean savePicture(String base64DataStr) {
        ...
        try {
          ...
          //通知相册更新
          sendEvent("noticeGalleryUpdata", "通知相册更新");
